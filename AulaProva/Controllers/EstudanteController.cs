...
using AulaProva.Models;

namespace AulaProva.Controllers
{
    public class EstudanteController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EstudanteId,Nome,Email")] Estudante estudante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EstudanteId,Nome,Email")] Estudante estudante)
        {
            if (ModelState.IsValid)
            {
